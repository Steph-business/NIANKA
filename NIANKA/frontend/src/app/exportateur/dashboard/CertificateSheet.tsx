...
export const CertificateSheet: React.FC<CertificateSheetProps> = ({ lots }) => {
  return (
    <div className="printable-area">
      {lots.map((lot) => {
        ...
        return (
          <div key={lot.arbitrage_id} className="certificate-page" style={{
            backgroundColor: '#fff',
            padding: '36px',
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '2px solid #1a6b0a', paddingBottom: '16px', marginBottom: '24px' }}>
              ...
              {/* Le QR Code officiel est gravé sur le certificat serveur, seul
                  document faisant foi (aucune dépendance à un service externe). */}
