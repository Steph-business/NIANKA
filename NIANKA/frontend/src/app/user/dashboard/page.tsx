...
export default function UserDashboardPage() {
  ...
  const totalScans = stats?.total_scans_count ?? scans.length;
  const korMoyen = stats?.kor_moyen ? `${stats.kor_moyen} lbs` : "—";
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px' }}>
        ...
        <div style={{
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <div style={{ fontSize: '34px', fontWeight: 900, color: '#0F172A', lineHeight: 1 }}>{totalScans}</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ marginTop: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
            <div>
              <div style={{ fontSize: '11.5px', fontWeight: 700, color: '#94A3B8' }}>Analyses Enregistrées</div>
        ...
        <div style={{
          ...
          {loading ? (
            ...
            <div style={{
              ...
              marginTop: '16px',
              borderRadius: '12px',
              backgroundImage: `url(${scans[0]?.image_url || '/images/anacarde.png'})`,
              ...
              <div style={{
                ...
                {scans.length > 0 && scans[0].gps_lat != null && scans[0].gps_long != null
                  ? `● ${scans[0].gps_lat.toFixed(4)}, ${scans[0].gps_long.toFixed(4)}`
                  : '● Position GPS non transmise'}
              </div>
            </div>
          )}
        </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: '12.5px', color: 'rgba(255,255,255,0.85)', margin: 0, lineHeight: 1.5, fontWeight: 500 }}>
              Démarrez une nouvelle session de collecte de noix de cajou.
            </p>
          </div>
