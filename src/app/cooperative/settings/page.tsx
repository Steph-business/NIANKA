...
import { Settings, Shield, Bell, Users, Save, CheckCircle2 } from 'lucide-react';

export default function CooperativeSettingsPage() {
  const [saved, setSaved] = useState(false);
  const [form, setForm] = useState({
    coopName: 'Coopérative ANADER Bouaké',
    zone: 'District du Bandama (Bouaké Nord)',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '28px', maxWidth: '1000px' }}>
      ...
      {saved && (
        <div style={{
          ...
          <span>Paramètres de la coopérative enregistrés avec succès !</span>
        </div>
      )}
