        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '20px' }}>
              ...
              <div style={{ backgroundColor: '#F8FAFC', padding: '14px', borderRadius: '14px' }}>
                <div style={{ fontSize: '11px', fontWeight: 800, color: '#94A3B8' }}>GRADE IA</div>
                <div style={{
          ...
          <>
            ...
            <thead>
              <tr style={{ borderBottom: '1.5px solid #F1F5F9', backgroundColor: '#F8FAFC' }}>
                ...
                <th style={{ padding: '16px 16px', fontSize: '11.5px', fontWeight: 800, color: '#64748B', letterSpacing: '0.06em' }}>GRADE IA</th>
